    ...
    <div className="flex flex-col items-center justify-center h-full mt-10">
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-inset ring-gray-200 px-6 py-5 max-w-lg w-full">
        ...
        <ul className="space-y-2 text-gray-600">
          ...
          <li className="flex items-start gap-2">
            <span className="text-blue-500 mt-1">•</span>
            <span>Send messages to Telegram users and groups</span>
          </li>
          {/* Nueva herramienta agregada */}
          <li className="flex items-start gap-2">
            <span className="text-blue-500 mt-1">•</span>
            <span>
              Generate detailed car market reports and deals using the Marketcheck API (zipcode 32789)
            </span>
          </li>
        </ul>
